...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RequestsLog.priority'
        db.alter_column(u'hello_requestslog', 'priority', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'RequestsLog.priority'
        db.alter_column(u'hello_requestslog', 'priority', self.gf('django.db.models.fields.CharField')(max_length=2))
